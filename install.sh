...
export UUID="dadf0ebf-034a-49cf-9f46-5a48ef01ae60"
# 调试输出：确认 UUID 已生成
...
curl ifconfig.me
count=1; while true; do echo "Attempt #$count:"; curl -Is http://www.google.com | head -n 1 && echo "Host is reachable" || echo "Host is unreachable"; count=$((count+1)); sleep 60; done
